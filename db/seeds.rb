...
[:keppler_admin].each do |name|
  Role.create name: name
  puts "Role #{name} has been created"
end

User.create(
  name: 'Anyelo Petit', email: 'anyelopetit@gmail.com', password: 'anyelop96',
  password_confirmation: 'anyelop96', role_ids: '1'
)
...
setting = Setting.create(
  ...
  smtp_setting_attributes: {
    ...
    email: 'anyelopetit@gmail.com', password: 'anyelop96'
  },
